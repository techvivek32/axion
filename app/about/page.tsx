          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'64px',alignItems:'start'}}>
            <div>
              ...
              <p style={{fontSize:'16px',color:'var(--muted)',lineHeight:1.85,marginBottom:'24px'}}>
                22+ years inside India&rsquo;s most complex organisations â€” Tata Group, Standard Chartered, Udaan, Gameskraft.
              </p>
              <div style={{display:'flex',flexWrap:'wrap',gap:'8px'}}>
                {['Tata Group','Standard Chartered','Udaan','Gameskraft'].map((c) => (
                  <span key={c} className="chip">{c}</span>
                ))}
                <span style={{fontSize:'10px',padding:'5px 13px',border:'1px solid rgba(200,168,108,.28)',borderRadius:'999px',color:'var(--gold)',letterSpacing:'.06em',fontWeight:600}}>CHRO / CPO Â· Active</span>
              </div>
            </div>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'16px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.025)',border:'1px solid rgba(255,255,255,.08)',borderRadius:'var(--r)',padding:'28px'}}>
                ...
                <Link href="/hros" style={{fontSize:'11px',color:'var(--gold)',letterSpacing:'.05em',fontWeight:500,textDecoration:'none'}}>Learn more â†’</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="inner">
          <div className="cta-panel">
            ...
            <div style={{display:'flex',gap:'14px',justifyContent:'center',flexWrap:'wrap'}}>
              <span className="bp" style={{fontSize:'14px',padding:'13px 30px',cursor:'pointer'}}>Connect â†’</span>
